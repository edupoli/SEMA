    ...
    public partial class Chamados : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowIndex >= 0)
            {
                ...
                {
                    string azul = "#3C8DBC";
                    e.Row.Cells[6].BackColor = System.Drawing.ColorTranslator.FromHtml(azul);
                    e.Row.Cells[6].ForeColor = System.Drawing.Color.White;
                }
                if (status == "Finalizado")
                {
                    string verde = "#478978";
                    e.Row.Cells[6].BackColor = System.Drawing.ColorTranslator.FromHtml(verde);
                    e.Row.Cells[6].ForeColor = System.Drawing.Color.White;
                }
                if (status == "Em Atendimento")
                {
                    string laranja = "#F39C12";
                    e.Row.Cells[6].BackColor = System.Drawing.ColorTranslator.FromHtml(laranja);
                    e.Row.Cells[6].ForeColor = System.Drawing.Color.Black;
                }
                if (status == "Pendente")
                {
                    string vermelho = "#DD4B39";
                    e.Row.Cells[6].BackColor = System.Drawing.ColorTranslator.FromHtml(vermelho);
                    e.Row.Cells[6].ForeColor = System.Drawing.Color.White;
                }
