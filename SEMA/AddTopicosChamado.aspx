                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:LinkButton ID="btnExcluirAssunto" CssClass="btn btn-danger" runat="server" data-toggle="tooltip" data-placement="top" title="Excluir" OnClick="btnExcluirAssunto_Click" OnClientClick="return confirm('Tem Certeza que deseja Excluir ? Esta ação é irreversível e tambem apagará todos os Topicos relacionados com esse Assunto')" ><i class="fas fa-trash"></i></asp:LinkButton>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:LinkButton ID="btnExcluirTopico" CssClass="btn btn-danger" runat="server" data-toggle="tooltip" data-placement="top" title="Excluir" OnClick="btnExcluirTopico_Click" OnClientClick="return confirm('Tem Certeza que deseja Excluir ? Esta ação é irreversível')"><i class="fas fa-trash"></i></asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
