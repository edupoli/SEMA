...
namespace SEMA
{
    public partial class Usuarios : System.Web.UI.Page
    {
        ...
        protected void btnVisualizar_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("/Paginas/Visualizar/ViewUsuarios.aspx?usuarioID=" + usuarioID);
        }
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                usuarioID = int.Parse((sender as LinkButton).CommandArgument);
                Response.Redirect("/Paginas/Editar/EditUsuarios.aspx?usuarioID=" + usuarioID);
            }
        }
        ...
        private void getUsuarios()
        {
            ...
            var resultado = (from a in ctx.usuarios
                             ...
                             where a.secretariaID == cod orderby a.nome ascending
                             select new
                             {
                                 a.id,
                                 a.nome,
